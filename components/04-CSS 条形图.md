...
.bar-label { width: 100px; flex-shrink: 0; font-size: 0.85rem; text-align: right; padding-right: 0.8em; color: var(--muted); }
.bar-track { flex: 1; height: 1.6em; background: var(--surface); border-radius: 3px; overflow: hidden; }
.bar-fill {
