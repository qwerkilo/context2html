"""Report-specific validation checks and D1-D5 humanization checks."""
import re
import os
...
# ========== Content-type structure checks ==========


def check_article_structure(html):
    """article type should have <article> elements."""
...
def check_doc_structure(html):
    """doc type should have a navigable TOC."""
...
def check_tutorial_structure(html):
    """tutorial type should have step indicators."""
...
def check_note_structure(html):
    """note type — lightweight, just basic content."""
    return []
